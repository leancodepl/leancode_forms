...
// Behaviour is split across the part files: focus in the _FocusHandling mixin,
// async rounds in the _Rounds extension type over this class. Round state stays
// on the class — an extension type holds none.
class AdvancedFieldController<T, E extends Object>
  ...
  /// user did not make.
  ///
  /// Throws a [StateError] if this field has already been disposed — disposed
