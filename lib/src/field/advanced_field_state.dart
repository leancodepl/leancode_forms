...
class AdvancedFieldState<T, E extends Object> with Equatable {
  ...
  /// When this field validates itself — the **effective** mode, with the form's
  /// `validationEnabled` switch already applied, so a field in a subtree whose
  /// validation is off reads [ValidationMode.disabled].
  ///
  /// Set it on the form, or on this field with
