...
class AdvancedFieldState<T, E extends Object> with Equatable {
  ...
  /// When this field validates itself, with nobody calling
  /// [AdvancedFieldController.validate].
  ///
  /// The effective mode: a field in a subtree whose validation is switched off
  /// reports [ValidationMode.disabled], which is what it behaves as. Set it
  /// with [AdvancedFieldController.setValidationMode], or on the form.
